...
open class RSLoadingSpinAlone: RSLoadingViewEffect {
  ...
  func setup(_ main: RSLoadingView) {
    ...
    if let particleSystem = main.loadParticleSystem(nameParticleSystem) {
      if let image = main.loadParticleImage(nameParticleImage) {
